...
class KimiBatchInputFile:
    ...
    def add_one_JSONL(
        ...
        if output_format is not None:
            body["response_format"] = _build_format_value(output_format)


        if thinking_effort is not None and model == "kimi-k3": # However, currently batch api does not support kimi-k3.
